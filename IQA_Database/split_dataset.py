...
class split_dataset:
    ...
    def AIGCIQA2023(self):
        ...
        data = []
        for i in positions:
            data.append(os.path.join('Image', 'allimg', names[i]) + '\t' + str(mos_quality[i]) + '\t' + str(mos_align[i]) + '\t' + str(texts[i]))
        return data
...
if __name__ == '__main__':
    ...
    index = {'AGIQA-3K': range(0, 300),
             'AIGCIQA2023': range(0, 100),
             'PKU-I2IQA' : range(0, 200)}
